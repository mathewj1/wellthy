"""
Copilot Money API Service for syncing expense data
"""
...
class CopilotService:
    """Service for interacting with Copilot Money API"""
    
    def __init__(self):
        self.api_key = os.getenv("COPILOT_API_KEY")
        self.base_url = os.getenv("COPILOT_API_URL", "https://api.copilot.money")
